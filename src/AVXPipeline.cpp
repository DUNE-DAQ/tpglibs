...
AVXPipeline::save_state(const __m256i& processed_signal) {
  __m256i active       = _mm256_cmpgt_epi16(processed_signal, m_zeros_register);
  __m256i inactive     = _mm256_cmpeq_epi16(processed_signal, m_zeros_register);
  __m256i was_inactive = _mm256_cmpeq_epi16(m_time_over_threshold, m_zeros_register);
  ...
  __m256i time_add = _mm256_blendv_epi8(m_zeros_register, m_ones_register, active);
...
AVXPipeline::check_for_tps(const __m256i& tp_mask) {
  ...
  // Negate!
  return !_mm256_testz_si256(tp_mask, m_max_value_register);
}
...
AVXPipeline::generate_tps(const __m256i& tp_mask) {
  ...
  __m256i time_over_threshold = _mm256_blendv_epi8(m_zeros_register, m_time_over_threshold, tp_mask);
  __m256i adc_integral_lo = _mm256_blendv_epi8(m_zeros_register, m_adc_integral_lo, tp_mask);
  __m256i adc_integral_hi = _mm256_blendv_epi8(m_zeros_register, m_adc_integral_hi, tp_mask);
  __m256i adc_peak = _mm256_blendv_epi8(m_zeros_register, m_adc_peak, tp_mask);
  __m256i time_peak = _mm256_blendv_epi8(m_zeros_register, m_time_peak, tp_mask);
  ...
  m_time_over_threshold = _mm256_blendv_epi8(m_time_over_threshold, m_zeros_register, tp_mask);
  m_adc_integral_lo     = _mm256_blendv_epi8(m_adc_integral_lo, m_zeros_register, tp_mask);
  m_adc_integral_hi     = _mm256_blendv_epi8(m_adc_integral_hi, m_zeros_register, tp_mask);
  m_adc_peak            = _mm256_blendv_epi8(m_adc_peak, m_zeros_register, tp_mask);
  m_time_peak           = _mm256_blendv_epi8(m_time_peak, m_zeros_register, tp_mask);
