...
#define BOOST_TEST_MODULE tp_reader_test
...
BOOST_AUTO_TEST_SUITE(TPReaderTest)
...
BOOST_AUTO_TEST_CASE(TestReadSingleFrame)
{
  ...
  // Read using TPReader
  tpglibs::testapp::TPReader reader(temp_filename);
...
BOOST_AUTO_TEST_CASE(TestInvalidFile)
{
  ...
  BOOST_CHECK_THROW(
    tpglibs::testapp::TPReader reader("/tmp/non_existent_tp_file.val"),
    std::runtime_error
  );
}
